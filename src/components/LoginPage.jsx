    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <h1 className="login-title">Wandersplit</h1>
          <p className="login-subtitle">Travel expenses, beautifully tracked</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {error && <p className="form-error" style={{padding: "8px 12px", background: "var(--error-pale)", borderRadius: "8px"}}>{error}</p>}
