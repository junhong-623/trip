...
export default function TripModal({ trip, onSave, onClose }) {
  ...
  const [form, setForm] = useState({
    ...
    baseCurrency: "USD", emoji: "🌍", driveFolderId: "",
  });
        ...
        <form onSubmit={handleSubmit} style={{display:"flex",flexDirection:"column",gap:16}}>
              ...
              {EMOJIS.map(e => (
                <button key={e} type="button"
                  style={{
                    ...
                    border: form.emoji === e ? "2px solid var(--terracotta)" : "2px solid var(--sand-deep)",
          ...
          <div className="form-group">
            ...
            <input className="form-input" required value={form.name}
              onChange={e => set("name", e.target.value)} placeholder="Japan Spring 2025" />
          </div>
          ...
          <div className="form-group">
            ...
            <select className="form-select" value={form.baseCurrency}
          ...
          <div className="form-group">
            <label className="form-label">{tr.driveFolderID}</label>
            <input className="form-input" value={form.driveFolderId}
          ...
          <div style={{display:"flex",gap:10,marginTop:4}}>
            ...
            <button type="submit" className="btn btn-primary" style={{flex:1}} disabled={saving}>
              {saving ? tr.saving : trip ? tr.saveChanges : tr.newTrip}
            </button>
          </div>
        </form>
      </div>
